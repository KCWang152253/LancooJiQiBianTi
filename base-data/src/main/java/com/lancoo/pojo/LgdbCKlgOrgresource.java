...
@Table(name = "Lgdb_C_Klg_OrgResource")
public class LgdbCKlgOrgresource {
    @Id
    @Column(name = "ID")
    private Long id;
    ...
    @Column(name = "IsSecondContext")
    private String issecondcontext;
    ...
    /**
     * @return IsSecondContext
     */
    public String getIssecondcontext() {
        return issecondcontext;
    }

    /**
     * @param issecondcontext
     */
    public void setIssecondcontext(String issecondcontext) {
        this.issecondcontext = issecondcontext;
    }
}